...
<div class="cp-section" id="section-clinical">
    ...
    <p class="cp-section-desc">Define qué dice el paciente (o el acompañante), qué le pasa y qué debe descubrir el estudiante.</p>
        ...
        <div class="cp-label-row">
            ...
            <span class="help-tooltip">
                ...
                <span class="help-tooltip-bubble">
                    ...
                    <div class="example">📝 "A ver, doctor, rapidito. Me ha obligado mi mujer a venir, pero yo estoy perfectamente."</div>
                </span>
            </span>
        </div>
    ...
    <div class="cp-form-group">
        <div class="cp-label-row">
            ...
            <span class="help-tooltip">
                ...
                <span class="help-tooltip-bubble">
                    <strong>¿Para qué sirve?</strong>
                    Los síntomas del paciente. Para cada uno defines cuándo lo revela: esto convierte la simulación en un ejercicio educativo real.
                    <div class="example">📝 "Dolor en el pecho" → Espontáneamente</div>
                    <div class="example">📝 "Dificultad para respirar" → Si le preguntan</div>
                    <div class="example">📝 "Bebe 3-4 carajillos" → Miente → "Lo normal, lo que bebe cualquier español"</div>
                </span>
            </span>
        </div>
            ...
            <div class="cp-dynamic-item">
                <div class="cp-dynamic-item-fields">
                    <div class="cp-dynamic-item-field">
                        <label>Síntoma</label>
                        <input type="text" name="symptoms[0][name]"
                               value="{{ old('symptoms.0.name') }}"
                    ...
                    <div class="cp-dynamic-item-field">
                        ...
                        <select name="symptoms[0][reveal]" class="reveal-select" onchange="handleRevealChange(this)">
                            <option value="espontaneo" {{ old('symptoms.0.reveal') == 'espontaneo' ? 'selected' : '' }}>Espontáneamente</option>
                            <option value="pregunta"   {{ old('symptoms.0.reveal') == 'pregunta'   ? 'selected' : '' }}>Si le preguntan</option>
                            <option value="oculta"     {{ old('symptoms.0.reveal') == 'oculta'     ? 'selected' : '' }}>Lo oculta</option>
                            <option value="miente"     {{ old('symptoms.0.reveal') == 'miente'     ? 'selected' : '' }}>Miente</option>
                            <option value="exagera"    {{ old('symptoms.0.reveal') == 'exagera'    ? 'selected' : '' }}>Exagera</option>
                        </select>
                    </div>
                    <div class="cp-lie-field {{ old('symptoms.0.reveal') == 'miente' ? 'visible' : '' }}" id="lie_symptoms_0">
                        <label>¿Qué dice en su lugar?</label>
                        <input type="text" name="symptoms[0][lie_text]"
                               value="{{ old('symptoms.0.lie_text') }}"
                ...
                <button type="button" class="cp-btn-remove" onclick="removeItem(this)" style="visibility: hidden;">
                    <i data-lucide="x"></i>
                </button>
            </div>
        </div>
    ...
    <div class="cp-form-group">
        <div class="cp-label-row">
            ...
            <span class="help-tooltip">
                ...
                <span class="help-tooltip-bubble">
                    <strong>¿Para qué sirve?</strong>
                    El diagnóstico que el paciente NO sabe. Se lo damos a la IA para mantener coherencia interna, pero <strong>nunca lo verbalizará</strong> al estudiante.
        ...
        <input type="text" id="real_diagnosis" name="real_diagnosis"
               value="{{ old('real_diagnosis') }}"
    ...
    <div class="cp-form-group">
        ...
        <div class="cp-dynamic-list" id="medicationsContainer"></div>
    ...
    <div class="cp-form-group">
        ...
        <div class="cp-dynamic-list" id="vicesContainer"></div>
