...
<div class="cp-section" id="section-extra">
    ...
    <div class="cp-form-group">
        <div class="cp-label-row">
            <label for="special_instructions">Instrucciones Especiales para la IA <span class="hint">(opcional)</span></label>
            <span class="help-tooltip">
                ...
                <span class="help-tooltip-bubble">
                    ...
                    <div class="example">📝 "Si el médico niega la baja, el paciente se indigna y amenaza con quejarse"</div>
                    <div class="example">📝 "Hacia el final de la consulta, pregunta si tendrá que quedarse ingresado"</div>
                </span>
            </span>
        </div>
    ...
    <div class="cp-form-group">
        <div class="cp-label-row">
            ...
            <span class="help-tooltip">
                ...
                <span class="help-tooltip-bubble">
                    <strong>¿Para qué sirve?</strong>
                    Las frases que dirá el paciente cuando le preguntan por datos que no tiene. Hacen el personaje más natural.
        ...
        <div class="cp-dynamic-list" id="frasesLimiteContainer"></div>
    ...
    <div class="cp-form-group">
        <div class="cp-label-row">
            ...
            <span class="help-tooltip">
                ...
                <span class="help-tooltip-bubble">
                    <strong>¿Para qué sirve?</strong>
                    Le enseña a la IA cómo improvisar respuestas coherentes con el personaje cuando el estudiante hace preguntas no cubiertas.
        ...
        <div class="cp-coherence-block">
            <div class="cp-form-group">
                ...
                <input type="text" id="ejemplo_coherencia_pregunta"
                       name="ejemplo_coherencia[pregunta]"
            ...
            <div class="cp-coherence-row">
                <div class="cp-form-group">
                    ...
                    <textarea id="ejemplo_coherencia_coherente"
                              name="ejemplo_coherencia[coherente]"
                              placeholder="Ej: Que va, doctor, ha estado toda la noche inquieto con la fiebre.">{{ old('ejemplo_coherencia.coherente') }}</textarea>
                </div>
                <div class="cp-form-group">
                    <div class="cp-label-row">
                        <label for="ejemplo_coherencia_incoherente" class="coherence-bad">❌ Respuesta incoherente</label>
                    </div>
                    <textarea id="ejemplo_coherencia_incoherente"
                              name="ejemplo_coherencia[incoherente]"
