...
<x-layouts.app>
    ...
    <x-slot name="title">Crear Asignatura</x-slot>
    ...
    <x-slot name="topbar">
        <div class="topbar">
            <div class="topbar-left">
                <div class="topbar-title">Nueva Asignatura</div>
                <div class="topbar-subtitle">Rellena los datos de la asignatura</div>
            </div>
        ...
        <div class="cp-section">
            ...
            <div class="cp-form-group">
                ...
                <input type="text"
                       ...
                       name="name"
                       value="{{ old('name') }}"
                       placeholder="Ej: Semiología Médica"
                       required>
                @error('name')
